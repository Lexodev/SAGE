TEST	= 0		; Set to 1 to enable small test code
			; The test code is not reentrant!
...
*********************************************************************
*	success = mt_resume( ptdata );
*	d0                  a2
*
*	Call to resume module. d0= FALSE if error.
*********************************************************************
*	mt_stop( ptdata );
*	         a2
*
...
;Build AHISampleInfo structure on stack and declare it:
	move.l	d2,-(sp)
	move.l	d3,-(sp)
	move.l	#AHIST_M8S,-(sp)
