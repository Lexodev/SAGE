...
#define SSCR_NOFLAG           0
#define SSCR_STRICTRES        1
#define SSCR_NOWINDOWEVT      2
#define SSCR_TRACKMOUSE       4
#define SSCR_DELTAMOUSE       8
#define SSCR_INDIRECT         16
...
/** Get the screen wait bitmap */
SAGE_Bitmap *SAGE_GetWaitBitmap(VOID);
...
/** Print a formatted text on screen */
BOOL SAGE_PrintFText(UWORD, UWORD, char *, ...);

/** Print a text directly on screen */
BOOL SAGE_PrintDirectText(STRPTR, UWORD, UWORD);

/** Print a formatted text directly on screen */
BOOL SAGE_PrintDirectFText(UWORD, UWORD, char *, ...);
