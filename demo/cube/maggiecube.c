...
// Maggie support only 16/32 bits screen
...
struct cube_object Cube = {
  ...
  {
    { 0,1,2,3, 1, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 },
    { 1,5,6,2, 2, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 },
    { 5,4,7,6, 3, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 },
    { 4,0,3,7, 4, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 },
    { 4,5,1,0, 5, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 },
    { 3,2,6,7, 6, 0,0,TEX_WIDTH-1,0,TEX_WIDTH-1,TEX_WIDTH-1,0,TEX_WIDTH-1 }
  }
};
...
BOOL OpenScreen(VOID)
{
  ...
  if (SAGE_OpenScreen(SCREEN_WIDTH, SCREEN_HEIGHT, 16, SSCR_TRIPLEBUF|SSCR_STRICTRES)) {
    SAGE_HideMouse();
    return TRUE;
  }
  SAGE_DisplayError();
...
BOOL InitEngine(VOID)
{
  ...
  if (SAGE_Set3DRenderSystem(S3DD_M3DRENDER)) {
    SAGE_AppliLog("Maggie texturing enable");
  }
